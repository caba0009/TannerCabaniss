#' P-Value Calculator
#'
#' This function calculates the p-value for a given t-calc value
#' and creates a graph that properly displays the given data
#'
#' @param t0 This is the t calc value you enter
#' @param xmax The max x-axis value
#' @param alpha the 1-alpha is the confidence interval being used
#'
#' @return The p-value and q.
#'
#' @examples mypvalue(t.test(x1,mu=22)$statistic)
#'
#' @export
